...
function register() {
    ...
    //checkCheckBox();
    console.log(id.value+","+passwd.value+","+username.value+","+email.value+","+number.value);

    console.log(checkPasswordFormat(passwd.value));
...
function checkNumber(value) {
  ...
  if( !valueCheck ){
      $('#birth-message').text('전화번호를 입력해주세요'); //수정
      return false;
  }else{
      $('#birth-message').text('');
      return true;
